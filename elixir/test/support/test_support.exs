defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          codex_allow_unsafe_merge_push: false,
    ...
    agent_engine = Keyword.get(config, :agent_engine)
    codex_command = Keyword.get(config, :codex_command)
    claude_command = Keyword.get(config, :claude_command)
    codex_approval_policy = Keyword.get(config, :codex_approval_policy)
    codex_thread_sandbox = Keyword.get(config, :codex_thread_sandbox)
    codex_turn_sandbox_policy = Keyword.get(config, :codex_turn_sandbox_policy)
    codex_allow_unsafe_merge_push = Keyword.get(config, :codex_allow_unsafe_merge_push)
    ...
    sections =
      [
        ...
        "agent:",
        agent_engine && "  engine: #{yaml_value(agent_engine)}",
        ...
        "  allow_unsafe_merge_push: #{yaml_value(codex_allow_unsafe_merge_push)}",
